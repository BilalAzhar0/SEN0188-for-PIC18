...
#define LCD_RW  1     // The RW bit of the PORT
#define LCD_RS  2     // The RS bit of the PORT
#define LCD_EN  3     // The EN bit of the PORT
#define LCD_D4  4     // The D4 bit of the PORT
#define LCD_D5  5     // The D5 bit of the PORT
#define LCD_D6  6     // The D6 bit of the PORT
#define LCD_D7  7     // The D7 bit of the PORT
